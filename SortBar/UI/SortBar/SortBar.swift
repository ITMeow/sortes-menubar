...
final class SortBarPanel: NSPanel {
    private weak var appState: AppState?

    private(set) var currentSection: MenuBarSection.Name?

    private lazy var colorManager = SortBarColorManager(iceBarPanel: self)
    ...
    private func updateOrigin(for screen: NSScreen) {
        ...
        func getOrigin(for iceBarLocation: SortBarLocation) -> CGPoint {
    ...
    func show(section: MenuBarSection.Name, on screen: NSScreen) async {
        ...
        contentView = SortBarHostingView(appState: appState, colorManager: colorManager, screen: screen, section: section) { [weak self] in
            self?.close()
        }
...
private final class SortBarHostingView: NSHostingView<AnyView> {
    ...
    init(
        appState: AppState,
        colorManager: SortBarColorManager,
        screen: NSScreen,
...
private struct IceBarContentView: View {
    ...
    @EnvironmentObject var colorManager: SortBarColorManager
