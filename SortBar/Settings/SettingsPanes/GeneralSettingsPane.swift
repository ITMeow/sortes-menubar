...
struct GeneralSettingsPane: View {
    ...
    private var iceIconOptions: some View {
        Toggle("Show SortBar icon", isOn: manager.bindings.showIceIcon)
            .annotation {
        ...
        if manager.showIceIcon {
            SortBarMenu("SortBar icon") {
                Picker("SortBar icon", selection: manager.bindings.iceIcon) {
    ...
    private var iceBarLocationPicker: some View {
        SortBarPicker("Location", selection: manager.bindings.iceBarLocation) {
            ForEach(SortBarLocation.allCases) { location in
    ...
    private var rehideStrategyPicker: some View {
        SortBarPicker("Strategy", selection: manager.bindings.rehideStrategy) {
